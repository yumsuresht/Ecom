...
if($username=='')
	$query_Recordset1 = "select * from userdetails where UserName <>'Admin'";
else
$query_Recordset1="select * from userdetails where UserName <>'Admin' and UserName like '".$username."%'";
...
{ 
$msg= $msg."<tr><td><span class=style17>".$row_Recordset1["UserName"]."</span></td>
<td><span class=style17>".$row_Recordset1["Profession"]."</span></td>
<td><span class=style17>".$row_Recordset1["Country"]."</span></td>
<td><span class=style17>".$row_Recordset1["Email"]."</span></td>
<td><span class=style17>".$row_Recordset1["LastLogin"]."</span></td></tr>";
}
}
...
<title>Online Digital Library-Administrator--&gt;Search Users </title>
<style type="text/css">
<!--
#Layer1 {
	position:absolute;
...
.style12 {color: #9E281E; font-weight: bold; font-size: x-small; }
.style14 {color: #9E281E; font-size: x-small; }
.style17 {color: #9E281E; font-weight: bold; font-size: 11px; }
.style21 {color: #FFFFFF; font-weight: bold; font-size: 11px; }
.style23 {font-size: 11px; color: #FFFFFF; }
.style25 {color: #FFFFFF; font-weight: bold; font-size: x-small; }
-->
</style>
</head>
<body>
	    ...
	    <table width="192" border="1" cellpadding="0" cellspacing="0" bordercolor="#9D281E">
          <tr>
            <td width="192" height="31" bgcolor="#9E281E"><div align="center" class="style5">
              <div align="left"><strong>Administrator--&gt;Search Users </strong></div>
            </div></td>
          </tr>
        </table>
...
<ilayer name="cmarquee01" height="&amp;{marqueeheight};" width="&amp;{marqueewidth};"></ilayer>
      ...
      <td width="604"><table width="587" border="0">
        ...
        <form name="form1" method="post" action="AdminSearchUsers.php">
          <table width="478" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#FF0000">
            
            <tr>
              <td width="114" rowspan="2" align="left" valign="top"><img src="img/pf_main_img.jpg" width="114" height="42"></td>
              <td colspan="2" bgcolor="#993333"><span class="style25">Search Users </span></td>
            </tr>
            <tr>
              <td width="99"><span class="style12">UserName</span></td>
              <td width="257"><label>
          ...
          <table width="568" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#9E281E">
            <tr>
              <td width="105" bgcolor="#9E281E"><span class="style21">UserName</span></td>
              <td width="135" bgcolor="#9E281E" class="style17"><span class="style23">Profession</span></td>
              <td width="129" bgcolor="#9E281E" class="style17"><span class="style23">Country/State</span></td>
              <td width="129" bgcolor="#9E281E" class="style17"><span class="style23">Email*</span></td>
              <td width="58" bgcolor="#9E281E" class="style17"><span class="style23">LastLogin</span></td>
            </tr>
            <tr>
              <td colspan="5"><span class="style14">
<? echo $msg; ?>
              </span></td>
            </tr>
          </table>
