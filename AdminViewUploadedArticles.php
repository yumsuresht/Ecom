...
mysql_select_db($database_ECOM, $ECOM);
$query_Recordset1 = "SELECT * FROM article ORDER BY NoofViewedUsers asc";
...
<title>Online Digital Library-Administrator--&gt;View Uploaded Articles</title>
<style type="text/css">
<!--
#Layer1 {
	position:absolute;
...
.style16 {font-size: x-small; color: #FFFFFF; font-weight: bold; }
-->
</style>
</head>
<body>
	    ...
	    <table width="192" border="1" cellpadding="0" cellspacing="0" bordercolor="#9D281E">
          <tr>
            <td width="192" height="31" bgcolor="#9E281E"><div align="center" class="style5">
              <div align="left"><strong>Administrator--&gt;View Uploaded Articles </strong></div>
            </div></td>
          </tr>
        </table>
...
<ilayer name="cmarquee01" height="&amp;{marqueeheight};" width="&amp;{marqueewidth};"></ilayer>
      ...
      <td width="604"><table width="587" border="0">
        ...
        <table width="569" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#9E281E">
          <tr>
            <td colspan="5" bgcolor="#9E281E"><div align="center"><span class="style16">Uploaded Articles </span></div></td>
          </tr>
          <tr>
            <td width="130"><div align="center"><span class="style14">Article Name </span></div></td>
            <td width="132"><div align="center"><span class="style14">Author</span></div></td>
            <td width="177"><div align="center"><span class="style14">Category</span></div></td>
            <td width="86"><div align="center"><span class="style14">Publish Date </span></div></td>
            <td width="32" bgcolor="#E2E2E2"><div align="center"><span class="style14">Hits </span></div></td>
          </tr>
	...
	$msg= "<tr><td><span class=style14><p><a href=AdminDeleteUploadedarticles.php?name=".$row_Recordset1["FileName"]."&ver=".$row_Recordset1["Version"].">"
.$row_Recordset1["articleName"]."</a></span></td>
	<td><span class=style14>".$row_Recordset1["Author"]."</span></td>
	<td><span class=style14>".$row_Recordset1["Category"]."</span></td>
	<td><div align=center><span class=style14>".$row_Recordset1["PublishDate"]."</span></div></td>";
	if($row_Recordset1["NoofViewedUsers"]<10)
	{
	$msg=$msg."<td bgcolor=#66FF00><div align=center><span class=style14>".$row_Recordset1["NoofViewedUsers"]."</span></div></td></tr>";
	}
	else
	{
	$msg=$msg."<td><div align=center><span class=style14>".$row_Recordset1["NoofViewedUsers"]."</span></div></td></tr>";
	}
	echo $msg;
