...
{ 
	$message=$message."<tr><td width=25>&nbsp;</td><td width=401><span class=style7><b>
	...
	"<br>Publish Date:".$row_Recordset1["PublishDate"].
	 "<a href=Uploaded_articles/".$row_Recordset1["FileName"]."><img src=img/atomic_download_md_wht.gif width=80 height=20></a></span><hr></td></tr>";
...
<title>Online Digital Library-Admin--&gt;Search Articles</title>
<style type="text/css">
<!--
#Layer1 {
	position:absolute;
...
document.onclick=hidemenu
	    ...
	    <table width="192" border="1" cellpadding="0" cellspacing="0" bordercolor="#9D281E">
          <tr>
            <td width="192" height="31" bgcolor="#9E281E"><div align="left"><span class="style5">Admin--&gt;Search Articles </span></div></td>
          </tr>
        </table>
...
<ilayer name="cmarquee01" height="&amp;{marqueeheight};" width="&amp;{marqueewidth};"></ilayer>
      ...
      <td width="604" valign="top"><table width="587" border="0">
        ...
        <form name="form1" method="post" action="AdminSearchArticles.php">
          <table width="539" height="18" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              <td width="77"><img src="img/2141947177.jpg" width="86" height="26"></td>
            ...
            <tr>
              <td colspan="3"><?php echo "<span class=style10>".$display."</SPAN>";?></td>
            </tr>
          </table>
        </form>
        ...
        <p><a href="AdminSearchUsers.php"></a></p>
      <p>&nbsp;</p>
      <p>&nbsp;</p>      </td>
    </tr>
  </table>
