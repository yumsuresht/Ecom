...
$query_Recordset2 = "SELECT * FROM hotnews";
$Recordset2 = mysql_query($query_Recordset2, $ECOM) or die(mysql_error());

//$_GET['doLogout']

mysql_select_db($database_ECOM, $ECOM);
$query_Recordset1 = "SELECT * FROM article where FileName='".$_GET['name']."' and Version='".$_GET['ver']."'";
...
<title>Online Digital Library-Administrator--&gt;Delete Uploaded Articles</title>
<style type="text/css">
<!--
#Layer1 {
	position:absolute;
...
.style12 {font-size: x-small; font-weight: bold; color: #9E281E; }
-->
</style>
</head>
<body>
	    ...
	    <table width="192" border="1" cellpadding="0" cellspacing="0" bordercolor="#9D281E">
          <tr>
            <td width="192" height="31" bgcolor="#9E281E"><div align="center" class="style5">
              <div align="left"><strong>Administrator--&gt;Delete Uploaded Articles </strong></div>
            </div></td>
          </tr>
        </table>
      ...
      <td width="604"><table width="587" border="0">
        <tr>
          ...
          <td width="87"><div align="right" class="style10">
              <div align="left"><a href="<?php echo $logoutAction ?>" class="style7"><img src="img/2752238159.jpg" width="27" height="29"></a><a href="<?php echo $logoutAction ?>" class="style7">Log out</a></div>
          </div></td>
        </tr>
		</table>
		...
		<div align="center">
		  <?php
		if($_SESSION['deletemsg']!=NULL)		
		 echo "<table width=447 border=1 align=center cellpadding=0 cellspacing=0 bordercolor=#9E281E bgcolor=#000066>
          <tr><td><div align=center><span class=style11>".$_SESSION['deletemsg']."</span></div></td></tr></table>"; ?>
		  <span class="style12"><a href="AdminViewUploadedArticles.php">Back</a></span>		</div>
		<form id="form1" action="delete.php" method="post" ENCTYPE="multipart/form-data">
		  <table width="455" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#9E281E">
          <tr>
            <td colspan="2" bgcolor="#9E281E"><div align="center"><span class="style11">Uploaded Articles Details</span> </div></td>
          </tr>
          <tr>
            <td width="164"><span class="style12">Name of Article </span></td>
            <td width="247"><label>
              <input name="textfield" type="text" size="50" value="<?php echo $row_Recordset1['articleName']; ?>">
            </label></td>
          </tr>
          <tr>
            <td valign="top"><span class="style12">Abstract</span></td>
            <td><label>
              <textarea name="textarea" cols="39" rows="4" wrap="virtual"><?php echo $row_Recordset1['Abstract']; ?></textarea>
            </label></td>
          </tr>
          <tr>
            <td><span class="style12">Author Name </span></td>
            <td><label>
              <input name="textfield2" type="text" size="40" value="<?php echo $row_Recordset1['Author']; ?>">
            </label></td>
          </tr>
          <tr>
            <td><span class="style12">Version</span></td>
            <td><label>
              <input name="textfield3" type="text" size="10" value="<?php echo $row_Recordset1['Version']; ?>">
            </label></td>
          </tr>
          <tr>
            <td><span class="style12">Category</span></td>
            <td><label>
              <input type="hidden" name="MM_update" value="form1">
              <input type="text" name="textfield4" value="<?php echo $row_Recordset1['Category']; ?>">
            </label></td>
          </tr>
          <tr>
            <td><span class="style12">PublishDate</span></td>
            <td><label>
              <input type="text" name="textfield5" value="<?php echo $row_Recordset1['PublishDate']; ?>">
            </label></td>
          </tr>
          <tr>
            <td><span class="style12">Hit Counts </span></td>
            <td><label>
              <input type="text" name="textfield6" value="<?php echo $row_Recordset1['NoofViewedUsers']; ?>">
            </label></td>
          </tr>
          <tr>
            <td>&nbsp;</td>
