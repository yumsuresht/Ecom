...
{
	$articlename=$_REQUEST['textfield3'];

	$query_Recordset2="select * from article where Abstract like '%".$articlename."%'";
	$display1="Search Article by Article:".$_REQUEST['textfield3'];
}
...
{ 
	...
	"<br>Publish Date:".$row_Recordset1["PublishDate"].
	 "<br>You Must Register with this website. After that You can download the Articles<a href=UserRegistration.php>Click to Register</a></span><hr></td></tr>";
