...
.style12 {font-size: x-small; color: #FF0000; font-weight: bold; }
...
menu1[3]='<a class="QuickLinks" href="AdminDeleteUploadedarticles.php">Delete Articles</a>'
...
document.onclick=hidemenu
	    ...
	    <table width="192" border="1" cellpadding="0" cellspacing="0" bordercolor="#9D281E">
          <tr>
            <td width="192" height="31" bgcolor="#9E281E"><div align="left"><span class="style5">Forgot Password </span></div></td>
          </tr>
        </table>
...
<ilayer name="cmarquee01" height="&amp;{marqueeheight};" width="&amp;{marqueewidth};"></ilayer>
      ...
      <td width="604" valign="top"><p>&nbsp;</p>
        <p align="center" class="bluebox style12 style14">If you've forgotten the password to your account,   please confirm your identity below and enter your username, question and Answer. The system will provide you with a new password.</p>
        <form name="form1" method="post" action="getpassword.php">
          <table width="398" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#9E281E">
            <tr>
              <td colspan="2" bgcolor="#9E281E"><span class="style6">Get your New Password, If you forgot </span></td>
            </tr>
            <tr>
              <td width="139"><span class="style12">UserName</span></td>
              <td width="243"><span class="style10">
                <label>
            ...
            <tr>
              <td><span class="style12">Answer</span></td>
              <td><span class="style10">
                <label>
            ...
            <tr>
              <td colspan="2"><span class="style12"><?php echo $_SESSION['Found'] ?></span></td>
            </tr>
          </table>
        </form>
        <p>&nbsp;</p>
