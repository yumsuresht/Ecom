...
window.onload=regenerate2
    ...
    <div class="center_column">
      <div class="box_right">
        ...
        <p><strong>Forgot Password</strong>?<a href="ForgotPassword.php">Click</a> </p>
        <hr />
        <p class="style3 style4"><a href="UserRegistration.php">New Registration </a></p>
        <p align="center"><img src="img/0,11855,5-102-17-900380-0,00.gif" alt="" width="130" height="65" align="absbottom" /></p>
      </div>
      <h5 class="style7"><img src="img/CABHT7HB.jpg" alt="" width="38" height="34" />User Name or Password is incorrect. Please Try again.</h5>
      <hr size="1" />
      <h5><strong>1. Use your User Name and Password to Login to the System<br/>
      2. Only registered Readers are allowed to read articles.</strong></h5>
      <br>
      <h5 class="style6">How to use the Online Digital Library </h5>
      <hr size="1" />
      <ul>
        <li>Any one can visit our site and can browse and read the   abstracts of articles. </li>
        <li>To download articles,users must have to register with this site. </li>
        <li>Registered member can download any number of articles. </li>
        <li>          User can search article by Article name or Author name.</li>
        <li>Further information go to FAQ's  </li>
      </ul>
      <h2>&nbsp;</h2>
    </div>
  </div>
