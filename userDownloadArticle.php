...
<title>Online Digital Library-User--&gt;Download Page</title>
<style type="text/css">
<!--
#Layer1 {
	position:absolute;
...
menu1[3]='<a class="QuickLinks" href="userSearcharticle.php">Search Articles</a>'
...
document.onclick=hidemenu
	    ...
	    <table width="192" border="1" cellpadding="0" cellspacing="0" bordercolor="#9D281E">
          <tr>
            <td width="192" height="31" bgcolor="#9E281E"><div align="left"><span class="style5">User--&gt;Download Page </span></div></td>
          </tr>
        </table>
...
var marqueecontents='<p align="center"><font color="#003366" font face="Verdana"><small>New Book Arraival<br>AAAAA<br>BBBBB<br></font>'
      ...
      <td width="604"><table width="587" border="0">
        <tr>
          ...
          <td width="87"><div align="right" class="style6">
              <div align="left"><a href="<?php echo $logoutAction ?>" class="style7">Log out</a></div>
          </div></td>
        </tr>
      </table>
      <p>&nbsp;</p>
