...
{
	if($row_Recordset1['Password']==md5($_POST['oldpass']))
	{
  $updateSQL = "UPDATE userdetails SET Password='".md5($_POST['newpass'])."' WHERE username='".$_SESSION['MM_Username']."'";
  mysql_select_db($database_ECOM, $ECOM);
  $Result1 = mysql_query($updateSQL, $ECOM) or die(mysql_error());
   $msgChange="<b><i><span class=style15>Your password is sucessfully Changed</span></b></i>";
  }
  else
  $msgChange="<b><i><span class=style15><img src=img/CABHT7HB.jpg width=30 height=37>Your previous password is wrong!!!!</span></b></i>";
}
...
<title>Online Digital Library-Administrator--&gt;Change Password </title>
<style type="text/css">
<!--
#Layer1 {
	position:absolute;
...
.style16 {font-size: x-small; color: #FFFFFF; }
.style15 {font-size: x-small; color: #9D281E; }
.style18 {font-size: x-small; color: #FFFFFF; font-weight: bold; }
-->
</style>
</head>
<body>
	    ...
	    <table width="192" border="1" cellpadding="0" cellspacing="0" bordercolor="#9D281E">
          <tr>
            <td width="192" height="31" bgcolor="#9E281E"><div align="center" class="style5">
              <div align="left"><strong>Administrator--&gt;Change Password </strong></div>
            </div></td>
          </tr>
        </table>
...
<ilayer name="cmarquee01" height="&amp;{marqueeheight};" width="&amp;{marqueewidth};"></ilayer>
      ...
      <td width="604" align="left" valign="top"><table width="587" border="0">
        <tr>
          <td width="490">&nbsp;</td>
          <td width="87" bordercolor="#993333"><div align="right" class="style10">
              <div align="left"><a href="<?php echo $logoutAction ?>" class="style7"><img src="img/2752238159.jpg" width="30" height="30" border="0">Log out</a></div>
          </div></td>
        </tr>
      </table>
        ...
        <table width="440" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#9D281E" bgcolor="#E2E2E2">
          <tr>
            <td width="115" rowspan="5" align="left" valign="top" class="style16"><img src="img/changePasword.jpg" width="115" height="120"></td>
            <td colspan="2" bgcolor="#993333" class="style16"><span class="style18">Change Password </span></td>
            </tr>
          <tr>
            <td width="115" class="style16"><span class="style15">Previous Password </span></td>
            <td width="202"><input name="oldpass" type="password" size="30"/>            </td>
          </tr>
          <tr>
            <td class="style16"><span class="style15">New Password </span></td>
            <td><label>
              <input name="newpass" type="password" id="newpass" size="30">
            </label></td>
          </tr>
          <tr>
            <td class="style16"><span class="style15">Confirm Password </span></td>
            <td><label>
              <input name="confirmpass" type="password" id="confirmpass" size="30">
            </label></td>
          </tr>
          ...
          <tr>
            <td><label>
                <div align="right">
                  ...
                  <input type="hidden" name="oldpass1" value="<?php echo base64_decode($row_Recordset1['Password']); ?>">
          ...
          <tr>
            <td colspan="3"><?php echo $msgChange ?>&nbsp;</td>
            </tr>
        </table>
